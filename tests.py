...
class BasicTestCase(unittest.TestCase):
	...
	def find_changes_swagger_only(self):

		pass

	def find_changes_Composite_to_nonComposie(self):
		pass

	def test_find_changes_folder_change(self):
		"""
		test to see if trafficmanager project returns a "folder change" 
		"""
	...
	def find_changes_md_changes(self):
		pass 
